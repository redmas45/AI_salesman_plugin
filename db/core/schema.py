...
CREATE TABLE IF NOT EXISTS hub_install_credentials (
    credential_id TEXT PRIMARY KEY,
    site_id TEXT NOT NULL REFERENCES hub_clients(site_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_hub_install_credentials_site_status
    ON hub_install_credentials(site_id, status);
