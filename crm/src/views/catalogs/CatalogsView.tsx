...
import { MiniMetric } from '../client-workspace/components/MiniMetric';
...
export function CatalogsView({
  ...
  const pagination = usePagination(filteredClients, DATA_CLIENT_PAGE_SIZE, `${normalizedQuery}|${statusFilter}`);
  return (
    <div className="stack">
      ...
      {filteredClients.length ? (
        <PaginationControl
          ...
          pageSize={DATA_CLIENT_PAGE_SIZE}
