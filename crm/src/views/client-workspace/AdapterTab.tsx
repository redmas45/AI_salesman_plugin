  ...
  return (
    <div className="tab-content fade-in">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Panel title="Live action candidates">
          {actionCandidates.length ? (
            <div className="grid gap-3">
              {actionCandidates.slice(0, 12).map((candidate) => (
                <div
                ...
                >
                  ...
                  <div className="mt-2 grid gap-1 text-sm text-muted">
                    ...
                    <span>Review: {candidateReviewLabel(candidate, actionReviews)}</span>
                  </div>
            ...
            <EmptyState text="Open a page with the install script to collect live buttons, links, and forms." />
          )}
        </Panel>
