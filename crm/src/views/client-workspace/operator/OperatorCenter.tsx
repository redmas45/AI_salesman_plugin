      ...
      <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_360px] max-[980px]:grid-cols-1">
        <div className="flex min-w-0 flex-col gap-5 bg-[linear-gradient(180deg,#ffffff,#fbfdff)] p-5">
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-2">
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-md border border-[#bfd3ff] bg-[#eef4ff] px-2 py-1 font-mono text-xs font-medium uppercase tracking-wider text-[#3b6ef8]">
          ...
          <div className="flex min-w-0 flex-col gap-1.5">
            <span className="text-xs font-medium uppercase tracking-wider text-[#64748b]">Next step</span>
  ...
  if (!saved) {
    return (
      <div className="flex min-w-0 flex-col gap-0.5 rounded border border-[#dce6f5] bg-[#f8fbff] p-3 opacity-75">
        ...
        <span className="mt-0.5 text-xs leading-relaxed text-[#64748b]">{detail}</span>
      </div>
    );
  }
  return (
