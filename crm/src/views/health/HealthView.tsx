...
const DOMAIN_CONTRACT_PAGE_SIZE = 5;
  ...
  return (
    <div id="domain-action-contracts">
      ...
      <PaginationControl
        ...
        pageSize={DOMAIN_CONTRACT_PAGE_SIZE}
